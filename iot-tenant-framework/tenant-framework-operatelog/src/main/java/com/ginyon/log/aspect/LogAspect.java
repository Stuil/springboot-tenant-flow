package com.ginyon.log.aspect;

import com.alibaba.fastjson2.JSON;
import com.ginyon.common.enums.HttpMethod;
...
import com.ginyon.log.enums.BusinessStatus;
import com.ginyon.log.filter.PropertyPreExcludeFilter;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            if (loginUser == null && !controllerLog.enableNoLogin()) {
                return;
            }
            // *========数据库日志=========*//
