package com.ginyon.thread.manager.factory;

import com.ginyon.common.constant.Constants;
import com.ginyon.common.utils.LogUtils;
...
import com.ginyon.system.api.ISysLogininforApi;
import com.ginyon.system.api.ISysOperLogApi;
    ...
    public static TimerTask recordLogininfor(final String username, final String status, final String message,
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                // 插入数据
                SpringUtils.getBean(ISysLogininforApi.class).insertLogininfor(logininfor);
            }
        };
    }
    ...
    public static TimerTask recordOper(final SysOperLog operLog) {
        return new TimerTask() {
            ...
            public void run() {
                ...
                SpringUtils.getBean(ISysOperLogApi.class).insertOperlog(operLog);
            }
        };
    }
}
