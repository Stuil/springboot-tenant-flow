...
import com.ginyon.common.utils.bean.BeanValidators;
 ...
 */
@Service
public class SysUserServiceImpl extends BaseServiceImpl<SysUserMapper, SysUser> implements ISysUserServeice {
    ...
    public boolean checkUserUnique(SysUser user) {
        return userMapper.exists(new LambdaQueryWrapper<SysUser>()
                .eq(TenantHelper.isEnable(), SysUser::getTenantId, user.getTenantId())
    ...
    public void checkUserAllowed(SysUser user) {
        if (StringUtils.isNotNull(user.getUserId()) && LoginHelper.isSuperAdmin(user.getUserId())) {
        ...
        for (SysUser user : userList) {
            try {
                ...
                if (StringUtils.isNull(u)) {
                    ...
                    user.setPassword(LoginHelper.encryptPassword(password));
