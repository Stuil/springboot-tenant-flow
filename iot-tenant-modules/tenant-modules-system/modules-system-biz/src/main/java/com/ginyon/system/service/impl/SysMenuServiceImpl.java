...
import com.ginyon.system.api.domain.vo.MetaVo;
import com.ginyon.system.api.domain.vo.RouterVo;
import com.ginyon.system.api.domain.vo.TreeSelect;
import com.ginyon.system.api.domain.SysTenantPackage;
import com.ginyon.system.mapper.SysMenuMapper;
 ...
 */
@Service
public class SysMenuServiceImpl extends BaseServiceImpl<SysMenuMapper, SysMenu> implements ISysMenuServeice {
    ...
    public List<Long> selectMenuListByPackageId(Long packageId) {
        ...
        return menuMapper.selectMenuListByPackageId(menuIds, tenantPackage.getMenuCheckStrictly());
    }
